# Open Data Connector - Java Client

Open Data Connector.<br/><img src='https://github.com/APIHub-CdC/imagenes-cdc/blob/master/circulo_de_credito-apihub.png' height='37' width='160'/></p><br/>
...
public class TelcosApiTest {
	...
	private String keystoreFile        = "your-keystore.jks";
	private String cdcCertFile         = "your-cdc-cert.pem";
	private String keystorePassword    = "your-password";
	private String keyAlias            = "your-key-alias";
	private String keyPassword         = "your-password";
